        ...
        where T : class
    {
        ...
        public HtmlString GetPagenation(IUrlHelper url,string action="index",string area="")
        {
            if(MaxPageCount < 2)
            {
                ...
                if (this.PageIndex == 1)
                {
                    sb.Append("<li disabled class='page-item'><a class='page-link pagination' href='#'>Previous</a></li>");
                }
                else
                {
                    ...
                    sb.Append(@$"<li class='page-item'><a class='page-link pagination' href='{link}'>Previous</a></li>");
                }
                ...
                for (int i = start; i <= end; i++)
                {
                    ...
                    if(i == this.PageIndex)
                    {
                        sb.Append(@$"<li class='page-item'><a class='page-link pagination'>{i}</li>");
                    }
                    else
                    {
                        sb.Append(@$"<li class='page-item'><a class='page-link pagination' href='{link}'>{i}</a></li>");
                    }
                }
                ...
                {
                    sb.Append("<li disabled class='page-item'><a class='page-link pagination' href='#'>Next</a></li>");
                }
                else
                {
                    string link = url.Action(action, values: new
                    ...
                    sb.Append(@$"<li class='page-item'><a class='page-link pagination' href='{link}'>Next</a></li>");
                }
